  ...
  return (
    <CodeBlockPrimitive
      ...
      className={cn(
        ...
        '[&>pre,_&_code]:!bg-transparent [&>pre,_&_code]:[background:transparent_!important] [&>pre,_&_code]:border-none [&_code]:!text-[13px] [&_code_.line]:!px-0 [&_code]:font-mono [&_code]:font-["JetBrains_Mono","Fira_Code","Consolas","Monaco","Courier_New",monospace]',
        cursor &&
